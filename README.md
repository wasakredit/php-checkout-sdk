...
$payload = array(
  ...
  'request_domain' => 'https://YOUR-BASE-DOMAIN.se/',
  'confirmation_callback_url' => 'https://YOUR-BASE-DOMAIN.se/payment-callback/',
  'ping_url' => 'https://YOUR-BASE-DOMAIN.se/ping-callback/'
);           
